...
import { CustomerInfoPurchases } from './CustomerInfoPurchases';
...
type Tab = 'overview' | 'purchases' | 'stats';
...
export function CustomerInfoDrawer({ id }: Props) {
  ...
  return (
    <div>
      ...
      {tab === 'purchases' && <CustomerInfoPurchases id={id} />}
